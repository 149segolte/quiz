	...
	render() {
		if (this.state.loading) return <div className="loading"></div>;
			...
			return (
				<>
					<Helmet>
						<title>{name}'s Leaderboard | Quizzer</title>
						<meta
							name="description"
							content={`Leaderboard for Quizzer quiz ${name}. Quizzer is a platform that allows you create fun quizzes and share with friends to take.`}
						/>
					</Helmet>
					<div
						style={{
